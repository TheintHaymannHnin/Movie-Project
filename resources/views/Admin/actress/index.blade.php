...
<div class="table-responsive">
    <table class="table table-bordered table-hover" style="background-color:RGB(255, 255, 255) ;">
        <a href="{{url('Admin/actresses/create')}}">
            <p align="right"><button class="btn btn-sm btn-dark mb-2" ><i class="fa fa-plus-circle"> Add Actress</i></button></p>
        </a>
            ...
            <td>{{$actress->updated_at}}</td> --}}
                <td>
                    ...
                    <form action="{{url('Admin/actresses/'.$actress->id)}}" method="POST">
                        ...
                        <a href="{{url('Admin/actresses/'.$actress->id.'/edit')}}"><button type="button" class="btn btn-outline-success btn-sm " style="border-radius:5px;"><i class="fa fa-edit"></i> Edit</button></a>
