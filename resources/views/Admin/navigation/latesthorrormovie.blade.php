...
<head>
  ...
  <title>Latest Horror Movies</title>
  <!-- CSS only -->
      ...
      <div class="col-md-12">
        ...
        <nav class="navbar navbar-expand-lg navbar-light mb-2" style="background-color:RGB(0, 0, 0);">
          ...
          <i><h3 class="text-white" align="center">Enjoy an always-changing selection of free movies, shows, , kids’ TV, and more.</h3></i><br><br>
                    ...
                    <div class="row mt-3 ml-5">
                        <marquee direction="left" height="90" width="1200" style="background-color:RGB(0, 0, 0);"><h1 class="text-white"><b><i>Latest Horror Movies</i></b></h1></marquee>
                    </div>
        ...
        <div class="row mt-3">
                ...
                <div class="col-sm-2 col-md-2 mb-2">
                  ...
                  <div class="col-sm-2 col-md-2 mb-2">
                    <a href="https://www.youtube.com/watch?v=W9uddyaqAPE"  target="_blank">
                      <div class="project-image-div">
                        
                        <img src="{{asset('images/h7.jpg')}}" width="200" height="250" class="project-img" alt="">
                        
                        <div class="overlay">
                          <div class="text mb-3">Patient Zero</div>
                        </div> 
